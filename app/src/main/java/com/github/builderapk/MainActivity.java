...
public class MainActivity extends Activity {
    ...
    @Override protected void onCreate(Bundle s) {
        ...
        // JS Bridge — allows JS to save files to Downloads/GITHUB APK Builder/
        ...
        wv.setDownloadListener((url, userAgent, contentDisposition, mimeType, contentLength) -> {
            ...
            // HTTP/HTTPS — use system DownloadManager → Downloads/GITHUB APK Builder/
            try {
    ...
    // Save raw bytes to Downloads/GITHUB APK Builder/filename
