package com.exaejrmple.myappj3ir;
...
public class MainActivity extends Activity {
    ...
    static final String APP_FOLDER = "MyAieifn";
    ...
    @Override protected void onCreate(Bundle s) {
        ...
        // JS Bridge — allows JS to save files to Downloads/MyAieifn/
        ...
        wv.setDownloadListener((url, userAgent, contentDisposition, mimeType, contentLength) -> {
            ...
            // HTTP/HTTPS — use system DownloadManager → Downloads/MyAieifn/
            try {
    ...
    // Save raw bytes to Downloads/MyAieifn/filename
