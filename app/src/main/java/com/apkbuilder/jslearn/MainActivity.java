...
public class MainActivity extends Activity {
    ...
    static final String APP_FOLDER = "Js learn";
    ...
    @Override protected void onCreate(Bundle s) {
        ...
        // JS Bridge — allows JS to save files to Downloads/Js learn/
        ...
        wv.setDownloadListener((url, userAgent, contentDisposition, mimeType, contentLength) -> {
            ...
            // HTTP/HTTPS — use system DownloadManager → Downloads/Js learn/
            try {
    ...
    // Save raw bytes to Downloads/Js learn/filename
